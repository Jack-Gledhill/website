...
export default function HostingAgreement() {
    return (
        <article>
            <Link href="/contracts">
            ...
            <h2>Web Hosting Agreement</h2>
            <p>This is a rolling monthly contract that charges a flat fee for hosting your website on my servers.</p>
            <button>
                <a href="/downloads/web_hosting_agreement_draft.pdf" className="p-4 rounded-lg shadow-lg text-white bg-blue hover:bg-blue-600 focus:bg-blue-600 border-2 border-blue focus:border-blue-300">
            ...
            <ul>
                ...
                <li>
                    <p>If either of us wants to terminate, we need to give at least 7 days' notice to the other;</p>
                </li>
            ...
            <ul>
                <li>
                    <p>You'll be charged £5 every month;</p>
                </li>
